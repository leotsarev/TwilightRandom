...
namespace Twilight.Web.Migrations
{
    ...
    [Migration("20260908110942_RemoveGameSlugAndNullablePlayerSlotSlug")]
    partial class RemoveGameSlugAndNullablePlayerSlotSlug
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Twilight.Domain.Faction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 25,
                            Name = "Last Bastion",
                            RussianName = "Последний Оплот",
                            WikiLink = "https://twilight-imperium.fandom.com/wiki/Last_Bastion"
                        },
                        new
                        {
                            Id = 26,
                            Name = "The Ral Nel Consortium",
                            RussianName = "Консорциум Рал-Нел",
                            WikiLink = "https://twilight-imperium.fandom.com/wiki/The_Ral_Nel_Consortium"
                        },
                        new
                        {
                            Id = 27,
                            Name = "The Crimson Rebellion",
                            RussianName = "Багровый Мятеж",
                            WikiLink = "https://twilight-imperium.fandom.com/wiki/The_Crimson_Rebellion"
                        },
                        new
                        {
                            Id = 28,
                            Name = "The Deepwrought Scholarate",
                            RussianName = "Школа Витой Бездны",
                            WikiLink = "https://twilight-imperium.fandom.com/wiki/The_Deepwrought_Scholarate"
                        },
                        new
                        {
                            Id = 29,
                            Name = "The Firmament / The Obsidian",
                            RussianName = "Небесная Твердь / Обсидиан",
                            WikiLink = "https://twilight-imperium.fandom.com/wiki/The_Firmament_%2F_The_Obsidian"
                        },
                        new
                        {
                            Id = 30,
                            Name = "The Council Keleres",
                            RussianName = "Совет Келерес",
                            WikiLink = "https://twilight-imperium.fandom.com/wiki/The_Council_Keleres"
                        });
                });
            ...
            modelBuilder.Entity("Twilight.Domain.Game", b =>
                {
                    b.HasOne("Twilight.Domain.Player", "CreatedByPlayer")
                        .WithMany()
